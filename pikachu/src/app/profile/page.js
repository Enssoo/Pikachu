...
export default function Profile() {
  const [avatarUrl, setAvatarUrl] = useState('/assets/profile.png');
      ...
      <section className={styles.container}>
        ...
        <article className={styles.infoContainter}>
          <section className={styles.info}>
            <img alt="foto de perfil" src={avatarUrl} width={100} height={100} className={styles.profile} />
            <section className={styles.textInfo}>
              <p className={styles.user}>User Name</p>
              <p className={styles.email}>username@email.com</p>
            </section>
          </section>
          <button className={styles.edit} onClick={() => window.location.href = '/chooseAvatar'}>
            Editar
          </button>
        </article>
